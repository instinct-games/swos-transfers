...
- **Shortlist** — star players you're interested in (`☆ List`), set a status
  (Interested / Scouting / Bid made / Bid rejected / Deal agreed) and keep
  free-text notes per player. `Sign ➜ Team` moves a bought player into your squad.
...
Your team, shortlist, statuses and notes are saved in the browser's
...
statuses and notes as a JSON file; Import restores from one, replacing the
